...
export default function PRSubjectSelector(props: any) {
  ...
  const { fnHandleClickedOnCalendar, setSubjectViewFilter, setMasterViewFilter, setMajorViewFilter } =
  ...
  return (
    <>
      ...
      >
        {viewSchedule || tempOn ? (
          <div className="pr-subject-select-body relative grid grid-rows-[auto_1fr] md:w-[450px] h-full overflow-auto p-1 rounded-3xl border-[1px] border-pr-bg-1 bg-white/90">
            {/* header */}
