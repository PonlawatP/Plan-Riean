...
import Logo from "./logoplanriean";

const landing = () => {
    return( <div className="">
    {/* <section> */}
    {/* bg-gradient-to-tr from-green-400 via-green-500 to-green-600 text-white p-4 rounded */}
      <div className='flex-col w-full h-9xl  rounded-bl-b25 ml-5] bg-gradient-to-br from-[#007AEB] to-[#503bd9] text-[#5E75FF] p-6 rounded '>
          <div className='flex pt-60 w-full justify-center max-sm:flex-col max-sm:pt-20 max-lg:flex-col max-lg:pt-20 max-xl:pt-36'>
            ...
            <div className='ml-20 text-[#FFFFFF] flex-col align-middle text-center max-sm:ml-0 max-lg:ml-0'>
              <h1 className='text-7xl max-sm:text-4xl'>PLANRIEAN<br />วางแผน การเรียน</h1>
              ...
              <div className='text-center w-full mt-6'>
                <button className='bg-[#FFFFFF] mt-5 w-full h-16 text-xl rounded-3xl  text-blue-500 max-lg:w-3/4'>ลองใช้เลย ตอนนี้!</button>
              </div>
            </div>
          </div>
          <div className='flex-col w-full mt-60 max-sm:mt-24 max-lg:mt-30'>
              ...
              <div className="w-full flex justify-center relative top-48 max-sm:top-10 max-xl:top-20">
