...
const landing = () => {
    ...
    {/* bg-gradient-to-tr from-green-400 via-green-500 to-green-600 text-white p-4 rounded */}
      <div className='flex-col w-full h-9xl  rounded-bl-b25 ml-5] bg-gradient-to-br from-[#007AEB] to-[#503bd9] text-[#5E75FF] p-6 rounded '>
          <div className='flex pt-60 w-full justify-center max-sm:flex-col max-sm:pt-20'>
            ...
            <div className='ml-20 text-[#FFFFFF] flex-col align-middle text-center max-sm:ml-0'>
              ...
              <div className='text-center w-full mt-6'>
                <button className='bg-[#FFFFFF] mt-5 w-full h-16 text-xl rounded-3xl  text-blue-500 max-sm:w-3/4'>ลองใช้เลย ตอนนี้!</button>
              </div>
            </div>
          </div>
          <div className='flex-col w-full mt-60 max-sm:mt-24'>
