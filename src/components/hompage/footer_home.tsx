                    ...
                    <div className="lg:w-[33%] max-md:my-5">
                        ...
                        <div className="p-3">
                            ...
                            <div className="flex max-md:justify-between justify-center items-center">
                                ...
                                <Link href="/">
                                    <svg className="mx-1" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
