        ...
        <div className="bg-gray-100 px-5 py-12 md:w-96 rounded-2xl shadow-lg">
          <div className="px-8">
            ...
            <form className="text-sm flex flex-col gap-4 mt-4">
              <input type="learner-id" className="p-2 rounded-xl border" placeholder="รหัสนิสิต / ชื่อผู้ใช้" />
              <input type="password" className="p-2 rounded-xl border w-full" placeholder="รหัสผ่าน" />
              <button
